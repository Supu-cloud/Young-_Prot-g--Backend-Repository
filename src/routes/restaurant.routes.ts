...
import { getAllRestaurants, getRestaurantById, createRestaurant, updateRestaurant, deleteRestaurant, toggleRestaurantStatus } from '../controllers/restaurant.controller';
