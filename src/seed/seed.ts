...
const seedDatabase = async () => {
  try {
    ...
    const pizzaItems = createdMenuItems.filter(
      (item) => item.restaurant.toString() === createdRestaurants[0]._id.toString()
    );
    ...
    const sampleOrders = [
      {
        ...
        items: [
          { menuItem: pizzaItems[0]._id, name: pizzaItems[0].name, quantity: 2, price: pizzaItems[0].price },
          { menuItem: pizzaItems[3]._id, name: pizzaItems[3].name, quantity: 1, price: pizzaItems[3].price },
        ],
      ...
      },
      {
        ...
        items: [
          ...
          { menuItem: createdMenuItems[8]._id, name: createdMenuItems[8].name, quantity: 2, price: createdMenuItems[8].price },
        ],
        totalAmount:     createdMenuItems[5].price + (createdMenuItems[8].price * 2),
        status:          'preparing',
